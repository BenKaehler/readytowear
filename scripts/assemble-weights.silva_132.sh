...
do
  tdir=$cdir/$ddir
  qiime feature-classifier fit-classifier-naive-bayes --i-reference-reads $tdir/ref-seqs.qza --i-reference-taxonomy $tdir/ref-tax.qza --o-classifier $pdir/SILVA_132_QIIME_release/uniform-classifier-$ddir.qza
  qiime clawback assemble-weights-from-Qiita --p-n-jobs $njobs --i-classifier $pdir/SILVA_132_QIIME_release/uniform-classifier-$ddir.qza --i-reference-taxonomy $tdir/ref-tax.qza --i-reference-sequences $tdir/ref-seqs.qza --p-context Deblur-Illumina-16S-V4-150nt-780653 --p-metadata-key empo_3 --p-metadata-value 'Animal distal gut' --p-metadata-value 'animal distal gut' --o-class-weight $tdir/animal-distal-gut.qza
  ...
  do
    ...
    qiime feature-classifier classify-sklearn \
      --i-classifier $pdir/SILVA_132_QIIME_release/uniform-classifier-$ddir.qza \
